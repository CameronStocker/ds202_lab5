...
B5 = 0.0309: estimate of the difference in the predicted log of glycosolated hemoglobin when frame is medium instead of large, holding all other covariates constant.

B6 = 0.0132: estimate of the difference in the predicted log of glycosolated hemoglobin when frame is small instead of large, holding all other covariates constant.
